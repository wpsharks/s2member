...
if(!class_exists("c_ws_plugin__s2member_menu_page_restriction_options"))
{
	/**
	 * Menu page for the s2Member plugin (Restriction Options page).
	 *
	 ...
	 * @since 110531
	 */
	class c_ws_plugin__s2member_menu_page_restriction_options
	{
		public function __construct()
		{
			...
			do_action("s2x_during_res_ops_page_before_left_sections", get_defined_vars());
			...
			{
				do_action("s2x_during_res_ops_page_during_left_sections_before_post_level_access", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_during_post_level_access", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_after_post_level_access", get_defined_vars());
			}
			...
			{
				do_action("s2x_during_res_ops_page_during_left_sections_before_page_level_access", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_during_page_level_access", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_after_page_level_access", get_defined_vars());
			}
			...
			{
				do_action("s2x_during_res_ops_page_during_left_sections_before_tag_level_access", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_during_tag_level_access", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_after_tag_level_access", get_defined_vars());
			}
			...
			{
				do_action("s2x_during_res_ops_page_during_left_sections_before_category_level_access", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_during_category_level_access", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_after_category_level_access", get_defined_vars());
			}
			...
			{
				do_action("s2x_during_res_ops_page_during_left_sections_before_uri_level_access", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_during_uri_level_access", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_after_uri_level_access", get_defined_vars());
			}
			...
			{
				do_action("s2x_during_res_ops_page_during_left_sections_before_query_level_access", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_after_query_level_access", get_defined_vars());
			}
			...
			{
				do_action("s2x_during_res_ops_page_during_left_sections_before_conditionals", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_during_conditionals", get_defined_vars());
				echo '</div>'."\n";
				...
				do_action("s2x_during_res_ops_page_during_left_sections_after_conditionals", get_defined_vars());
			}
			if(apply_filters("ws_plugin__s2member_during_res_ops_page_during_left_sections_display_sp_access", TRUE, get_defined_vars()))
			{
				do_action("s2x_during_res_ops_page_during_left_sections_before_sp_access", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_during_sp_access", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_after_sp_access", get_defined_vars());
			}
			...
			{
				do_action("s2x_during_res_ops_page_during_left_sections_before_brute_force_restrictions", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_during_ip_restrictions", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_after_ip_restrictions", get_defined_vars());
			}
			...
			{
				do_action("s2x_during_res_ops_page_during_left_sections_before_ip_restrictions", get_defined_vars());
			...
			{
				do_action("s2x_during_res_ops_page_during_left_sections_before_slogin_restrictions", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_during_slogin_restrictions", get_defined_vars());
				...
				do_action("s2x_during_res_ops_page_during_left_sections_after_slogin_restrictions", get_defined_vars());
			}
			do_action("s2x_during_res_ops_page_after_left_sections", get_defined_vars());
...
new c_ws_plugin__s2member_menu_page_restriction_options();
