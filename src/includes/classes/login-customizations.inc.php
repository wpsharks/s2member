...
if(!class_exists('c_ws_plugin__s2member_login_customizations'))
{
	...
	class c_ws_plugin__s2member_login_customizations
	{
		...
		public static function login_header_styles()
		{
			...
			$a[] = '@supports (-moz-appearance: none){ div#login form select { font-size:'.min((int)$GLOBALS['WS_PLUGIN__']['s2member']['o']['login_reg_font_field_size'], 15).'px'.$i.'; } }'; // Mozilla doesn't like the larger font size. This corrects that issue in Firefox.
